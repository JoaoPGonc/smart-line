...
const endDiv = code.indexOf('      {/* Bottom Navigation Tabs */}');
const popupCode = `
      {showStartPrompt && (
            ...
            <div className="p-6 text-center space-y-4">
              ...
              <div className="flex flex-col gap-3 pt-2">
                ...
                <button
                  onClick={() => {
                    setShowStartPrompt(false);
                    const url = generateGoogleMapsUrl(originCoords, destCoords, appointment?.routeStops || []);
...
code = code.slice(0, endDiv) + popupCode + code.slice(endDiv);
